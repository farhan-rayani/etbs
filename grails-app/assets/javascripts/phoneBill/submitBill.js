...
$(document).ready(function() {	
	...
	$(window).bind("load resize", function() {
		...
		if(this.screen.height == 768)
		{
			oSettings._iDisplayLength = 12;
			newLength = [12, 25, 50, 100, -1];
		}
		else if(this.screen.height > 768 && this.screen.height < 900)
		{
			oSettings._iDisplayLength = 14;
			newLength = [14, 25, 50, 100, -1];
		}
		else if(this.screen.height >= 900 && this.screen.height <= 960)
		{
			oSettings._iDisplayLength = 16;
			newLength = [16, 25, 50, 100, -1];
		}
		else if(this.screen.height > 960 && this.screen.height < 1024)
		{
			oSettings._iDisplayLength = 18;
			newLength = [18, 25, 50, 100, -1];
		}
		else if(this.screen.height >= 1024 && this.screen.height < 1440)
		{
			oSettings._iDisplayLength = 20;
			newLength = [20, 25, 50, 100, -1];
		}
		else if(this.screen.height >= 1440)
		{
			oSettings._iDisplayLength = 30;
			newLength = [30, 50, 75, 100, -1];
		}
...
$(".officialCheckbox").click(function() {
    ...
    if($(this).is(':checked') == true && $("#personal" + objId).is(':checked') == true){
    	...
    	//console.log("amount "+amount +" personalAmount "+personalAmount.toFixed(2)+ " officialAmount "+officialAmount.toFixed(2))
    	 $("#totalOfficialAmount").text(officialAmount.toFixed(2))
    	 $("#totalPersonalAmount").text(personalAmount.toFixed(2))
    }
    	...
    	//console.log("amount "+amount +" officialAmount "+officialAmount.toFixed(2)+ " uncategorizedAmount "+uncategorizedAmount.toFixed(2))
    	$("#totalUncategorizedAmount").text(uncategorizedAmount.toFixed(2))
    	$("#totalOfficialAmount").text(officialAmount.toFixed(2))
    }
...
$(".parentpersonalCheckbox").click(function() {
	...
	if ($(this).is(':checked') == true && $("#parentofficial" + objId).is(':checked') == true){
    	...
    	//console.log("amount "+amount +" personalAmount "+personalAmount.toFixed(2)+ " uncategorizedAmount "+uncategorizedAmount.toFixed(2))
    	$("#totalUncategorizedAmount").text(uncategorizedAmount.toFixed(2))
    	$("#totalPersonalAmount").text(personalAmount.toFixed(2))
    }
...
function generateFilterParams() {
    if ($("#phoneNo :selected").val()) {
        phoneNo = $("#phoneNo :selected").val()
    } else {
        phoneNo = ""
    }
    var params = '&filter_0=' + document.getElementById("filter_0").checked + "&filter_1=" + document.getElementById("filter_1").checked + "&filter_2=" +
        document.getElementById("filter_2").checked + "&phoneNo=" + phoneNo
    return params
}
